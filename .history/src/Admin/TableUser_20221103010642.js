...
const TableUser = () => {
                            ...
                            if (
                                ...
                                rawCSV.map((item, index) => {
                                    if (index > 0 && item.length === 4) {
                                        ...
                                        obj.Id = item[0];
                                        obj.Email = item[1];
                                        obj.("First name") = item[2];
                                        obj.("Last name") = item[3];
                                        result.push(obj);
                                    }
                                });
                                setListUsers(result);
    ...
    return (
        <Container>
            <div className="add-new my-3 d-sm-flex justify-content-between align-items-center">
                ...
                <div className="group-btns mt-sm-0 mt-2">
                    <label htmlFor="test" className="btn btn-warning">
                        <i className="fas fa-upload"></i> {t("table.title2")}
                    </label>
                    <input
                        id="test"
                        type="file"
                ...
                <Table striped bordered hover>
                    <thead>
                        <tr>
                            ...
                            <th>{t("table.title7")}</th>
                            <th>{t("table.title8")}</th>
                        </tr>
                    </thead>
                    <tbody>
                        {listUsers &&
                                ...
                                return (
                                    <tr key={`users-${index}`}>
                                        ...
                                        <td>
                                            ...
                                            <button
                                                className="btn btn-danger mt-lg-0 mt-1 text-center mx-2 mx-lg-0"
                                                onClick={() =>
            ...
            <ReactPaginate
                breakLabel="..."
                nextLabel={t("table.title11")}
                onPageChange={handlePageClick}
                pageRangeDisplayed={5}
                pageCount={totallPages}
                previousLabel={t("table.title12")}
